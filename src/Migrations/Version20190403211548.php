 ...
 */
final class Version20190403211548 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users_groups (users_id INT NOT NULL, groups_id INT NOT NULL, INDEX IDX_FF8AB7E0F373DCF (groups_id), INDEX IDX_FF8AB7E067B3B43D (users_id), PRIMARY KEY(users_id, groups_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
